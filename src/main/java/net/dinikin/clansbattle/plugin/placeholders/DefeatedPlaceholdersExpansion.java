...
public class DefeatedPlaceholdersExpansion extends AbstractPlaceholdersExpansion {


    public DefeatedPlaceholdersExpansion(ClansBattlePlugin plugin) {
        super(plugin);
    }
    ...
    public String onPlaceholderRequest(Player player, String regionName) {
        ...
        if (region != null) {
            String defeated = region.getDefeated();
            return defeated == null ? "" : Clan.clanUtil.getClan(defeated).getClanTag();
        }
        return "";
    }
}
